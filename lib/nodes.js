...
/**
 * NodeAksesVariabel, Akses ke variabel / keyword
 * -
 */
...
/**
 * NodeKelas, class untuk menyimpan class
 * -
 */
 class NodeKelas {
    constructor(nama_kelas, metodes) {
        this.nama_kelas = nama_kelas
        this.metode = metodes

        if (this.nama_kelas) {
            this.posisi_awal = this.nama_kelas.posisi_awal
        } else {
            this.posisi_awal = this.metode[0].posisi_awal
        }

        this.posisi_akhir = this.metode[this.metode.length-1].posisi_akhir
    }
}
 ...
 */
 class NodeIndeks {
    constructor(node_untuk_indeks, indeks, interp_indeks = true, editIndeks = null) {
        this.node_untuk_indeks = node_untuk_indeks
        this.indeks = indeks
        this.interp_indeks = interp_indeks
        this.editIndeks = editIndeks

        this.posisi_awal = this.node_untuk_indeks.posisi_awal
        this.posisi_akhir = this.indeks[this.indeks.length-1].posisi_akhir
    }
}
...
/**
 * NodeEkspor, hampir sama dengan return namun untuk ekspor module
 * -
 */
 class NodeEkspor {
    constructor(node_ekspor, poisi_awal, poisi_akhir) {
        this.node_untuk_ekspor = node_ekspor
