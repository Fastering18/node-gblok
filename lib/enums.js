...
/**
 * Package manager, client - server
 */
enums.PKGManager = {};
enums.PKGManager.baseURL = "https://gbpm.fastering181.repl.co"; //"https://package.gblk.ga"; //"https://packages2.gblk.ga";
enums.PKGManager.loginURL = "/api/v1/login";
enums.PKGManager.browserLoginURL = "/login";
enums.PKGManager.publishPackageURL = "/api/v1/new/package";
enums.PKGManager.installPackageURL = "/api/v1/packages/%s/%s";
